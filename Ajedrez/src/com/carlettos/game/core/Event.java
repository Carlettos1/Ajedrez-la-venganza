...
public abstract class Event implements Comparable<Event> {
     ...
     */
    private Event(int turnos, String nombre, Point punto, Board tablero) {
        if (turnos <= 0) {
    ...
    public static final class Builder {
        ...
        public Event build(Operator operator){
            return new Event(this.turnos, this.nombre, this.punto, this.tablero) {
                @Override
                public void accion() {
