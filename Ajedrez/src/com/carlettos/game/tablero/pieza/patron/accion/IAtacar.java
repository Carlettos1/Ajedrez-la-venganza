...
public interface IAtacar<P extends Patron> {
     ...
     */
    public default ActionResult canAtacar(AbstractTablero tablero, Point inicio, Point final_, P patron){
     ...
     */
    public default boolean checkAtacarCondition(AbstractTablero tablero, Point inicio, Point final_) {
