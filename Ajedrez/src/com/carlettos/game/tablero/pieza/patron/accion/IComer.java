...
public interface IComer<P extends Patron> {
     ...
     */
    public default ActionResult canComer(AbstractTablero tablero, Point inicio, Point final_, P patron) {
     ...
     */
    public default boolean checkComerCondition(AbstractTablero tablero, Point inicio, Point final_) {
