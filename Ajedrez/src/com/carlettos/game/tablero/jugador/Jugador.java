package com.carlettos.game.tablero.jugador;

import com.carlettos.game.tablero.manager.Mano;
...
public class Jugador {
     ...
     * @see Mano
     */
    public Jugador(int movimientosPorTurnos, int mana, String id, Color color, Mano mano) {
        this.color = color;
     ...
     * @see Mano
     */
    public Jugador(String id, Mano mano, Color color) {
