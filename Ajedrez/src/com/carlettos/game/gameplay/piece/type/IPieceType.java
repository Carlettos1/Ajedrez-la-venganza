...
public interface IPieceType {
    ...
    /**
     * Its executed every time that a piece with this type makes an action. 
     * The other (and its pos) will be null on movement or in some abilities.
     * 
     * @param data record with the information.
     */
    ...
    /**
     * Its executed every time that some other piece tries to make an action to a piece with this type.
     *  The other (and its pos) will be null in some abilities.
     * 
     * @param data record with the information.
     */
    ...
    /**
     * Its executed every time that some other piece makes an action to a piece with this type.
     *  The other (and its pos) will be null in some abilities.
     * 
     * @param data record with the information.
     */
