...
/**
 * Clase que cumple la función de reloj, controla el tiempo de los eventos y el
 * turno de los jugadores.
 *
 * @author Carlos
 */
public class RelojManager {
    ...
    public RelojManager(Jugador... jugadores) {
        this.movimientos = 0;
        this.turno = 1;
        this.eventos = new ArrayList<>();
        this.jugadores = new ArrayList<>();
        this.jugadores.addAll(Arrays.asList(jugadores));
    }
