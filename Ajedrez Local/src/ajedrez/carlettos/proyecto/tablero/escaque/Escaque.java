...
import ajedrez.carlettos.proyecto.estructura.base.Estructura;
import ajedrez.carlettos.proyecto.pieza.base.Pieza;
import ajedrez.carlettos.proyecto.pieza.base.Vacia;
...
public class Escaque {
     ...
     * pieza Vacia.
     * @param estructura estructura que tiene el escaque, si no tiene ninguna,
     ...
     * @see Estructura
     */
    public Escaque(boolean isFuenteDeMagia, boolean isConstruible, Point localizacion, Pieza pieza, Estructura estructura) {
    ...
    public Escaque(Point localizacion) {
        this(false, true, localizacion, new Vacia(), new Inexistente());
    }
